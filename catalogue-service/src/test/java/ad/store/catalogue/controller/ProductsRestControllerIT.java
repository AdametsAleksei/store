...
class ProductsRestControllerIT {
    ...
    void findProducts_RerunsProductsList() throws Exception {
    ...
    void createProduct_RequestIsValid_ReturnsNewProduct() throws Exception {
        ...
        var requestBuilder = MockMvcRequestBuilders.post("/catalogue-api/products")
                ...
                .content("""
                        {"title": "Ещё один новый товар", "details": "Описание для ещё одного товара"}
                        """)
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON),
                        content().json("""
                                {"id": 1, "title": "Ещё один новый товар", "details": "Описание для ещё одного товара"}
                                """)
    ...
    void createProduct_RequestIsInvalid_ReturnsProblemDetail() throws Exception {
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        jsonPath("$.errors", hasItem("Название товара должно быть указано"))
                );
    }
